...
class UI:
    ...
    def show_exp(self, exp):
        ...
        pygame.draw.rect(self.display_surface, 'darkgreen', text_rect.inflate(10, 10), 3)
    ...
    def selection_box(self, left, top, has_switched):
        ...
        if has_switched:
            ...
            pygame.draw.rect(self.display_surface, "silver", bg_rect, 3)
    ...
    def display(self, player):
        ...
        self.magic_overlay(player.magic_index, player.can_switch_weapon)