...
class Upgrade:
    def __init__(self, player):
        ...
        self.attribue_names = list(player.stats.keys())
    ...
    def display(self):
        ...
        for index, item in enumerate(self.item_list):
            #get attrib
            name = self.attribue_names[index]
...
class Item:
    ...
    def trigger(self, player):
        ...
        if player.exp >= player.upgrade_cost[upgrade_attrib] and player.stats[upgrade_attrib] < player.max_stats[upgrade_attrib]:
            player.exp -= player.upgrade_cost[upgrade_attrib]
            player.stats[upgrade_attrib] *= 1.2
            player.upgrade_cost[upgrade_attrib] *= 1.4
